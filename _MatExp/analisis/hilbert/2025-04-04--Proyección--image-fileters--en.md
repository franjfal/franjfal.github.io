---
title: "Interactive Image Filtering with the Discrete Fourier Transform (DFT)"
...
permalink: "/MatExp/analysis/hilbert/image-filter/"

header:
  image: "/assets/MatExp/analisis/hilbert/image-filter/header.jpg"
excerpt: "Discover how images can be filtered with the Discrete Fourier Transform (DFT). Upload an image, inspect its frequency-domain representation, apply low-pass, high-pass or band-pass filters, and compare the spectrum with the resulting image."
