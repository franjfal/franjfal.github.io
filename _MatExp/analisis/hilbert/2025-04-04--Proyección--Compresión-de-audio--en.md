---
title: "Interactive Demo - Audio Compression with the DFT"
...
permalink: "/MatExp/analysis/hilbert/audio-compression/"

header:
  image: "/assets/MatExp/analisis/hilbert/audio-conversion/header.jpg"
excerpt: "Explore how sound can be compressed with an interactive demo based on the Discrete Fourier Transform (DFT). Upload or record your own audio, watch it move into the frequency domain, remove the least important components, and listen to how the result changes."
