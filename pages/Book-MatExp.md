...
- Modelo del sistema solar a escala [(PDF)](/assets/MatExp/geometria/conicas/sistema-solar-a-escala/Modelo-a-escala-del-sistema-solar.pdf)
- Fichas de los planetas: [Mercurio](/assets/MatExp/geometria/conicas/sistema-solar-a-escala/Mercurio.pdf), [Venus](/assets/MatExp/geometria/conicas/sistema-solar-a-escala/Venus.pdf), [Tierra](/assets/MatExp/geometria/conicas/sistema-solar-a-escala/Tierra.pdf), [Marte](/assets/MatExp/geometria/conicas/sistema-solar-a-escala/Marte.pdf), [Júpiter](/assets/MatExp/geometria/conicas/sistema-solar-a-escala/Jupiter.pdf), [Saturno](/assets/MatExp/geometria/conicas/sistema-solar-a-escala/Saturno.pdf), [Urano](/assets/MatExp/geometria/conicas/sistema-solar-a-escala/Urano.pdf), [Neptuno](/assets/MatExp/geometria/conicas/sistema-solar-a-escala/Neptuno.pdf)

### 2. Grafos y conexiones: Donde menos es más

- Trazos en papel (representación de grafos con chinchetas e hilo)
- Coloración de mapas: [mandala](/assets/MatExp/discreta/grafos/cuatro-colores/Mandala.pdf), [mandalas alternativas](http://www.supercoloring.com/es/dibujos-para-colorear/artes-y-cultura/mandala){:target="_blank"}, [mapas para colorear](http://www.supercoloring.com/es/dibujos-para-colorear/paises-y-culturas/mapas){:target="_blank"}
...
- Construcción de teselados: [triángulo](/assets/MatExp/geometria/teselados/construccion/Teselado-3-lados.pdf), [cuadrado](/assets/MatExp/geometria/teselados/construccion/Teselado-4-lados.pdf), [hexágono](/assets/MatExp/geometria/teselados/construccion/Teselado-6-lados.pdf)
...
- [Calendario dodecaédrico (PDF)](/assets/MatExp/geometria/poliedros/calendario-dodecaedro/Calendario-Dodecaedrico.pdf)
...
- [Construcción de un hipercubo (PDF)](/assets/MatExp/geometria/politopos/hipercubo/hipercubo.pdf)
...
- Juego de mesa sobre epidemias: [tablero (PDF)](/assets/MatExp/aplicada/modelizacion/juego-epidemias/El-juego-de-las-epidemias--tablero-6x6.pdf), [simulación online](https://www.nctm.org/tools/pandemic2020/index.html){:target="_blank"}
