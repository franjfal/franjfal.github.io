---
title: "Book: Experimental Mathematics"
permalink: /books/experimental-mathematics/
excerpt: Complementary material for the book "Matemáticas experimentales", published in the Estímulos Matemáticos collection jointly edited by the RSME and SM.
lang: en
page_id: matexp-book
---
...
**Matemáticas experimentales** is a mathematics outreach book published in the *Estímulos Matemáticos* collection, jointly edited by the Royal Spanish Mathematical Society (RSME) and SM.

Through hands-on, visual and interactive activities, the book offers a different way of approaching mathematics, connecting fundamental concepts with practical experiences that encourage curiosity, exploration and discovery.
...
<div class="book-container">
  <div class="book-cover">
    <img src="/assets/MatExp/libro/PortadaMatExp.jpg" alt="Cover of the book Matemáticas Experimentales" style="width:100%; height:auto;">
  </div>
  <div class="book-info">
    <h2><em>Matemáticas Experimentales</em></h2>

    <p><i class="fas fa-user"></i><strong>Author:</strong> Francisco Javier Falcó Benavent</p>
    <p><i class="fas fa-building"></i><strong>Publisher:</strong> Ediciones SM / RSME - Estímulos Matemáticos collection</p>
    <p><i class="fas fa-calendar-alt"></i><strong>Year:</strong> 2022</p>
    <p><i class="fas fa-barcode"></i><strong>ISBN:</strong> 978-8413929293</p>
  </div>
</div>

**Summary:**  
In elementary mathematics, hands-on activities are strongly integrated into teaching because they help students visualize and understand concepts. In advanced mathematics, however, their presence becomes much more limited.

In this book we rediscover five key mathematical theories whose definitions and results are complemented by applications to everyday situations and teaching proposals that allow us to see and touch the mathematical world.

As mathematician Stanley Gudder wrote, "The essence of mathematics is not to make simple things complicated, but to make complicated things simple." In that same spirit, this book aims to turn complex abstractions into accessible knowledge.

<p>
  <a href="https://es.literaturasm.com/libro/matematicas-experimentales" target="_blank">
    <i class="fas fa-globe"></i> Official page
  </a><br>
  ...
  <a href="https://www.rsme.es/2022/06/matematicas-experimentales-nuevo-libro-de-la-biblioteca-estimulos-matematicos/" target="_blank">
    <i class="fas fa-newspaper"></i> RSME note
  </a>
</p>

## Complementary material

### 1. Conic sections and planetary orbits
...
- [The tangent line - Direction of the train](/en/MatExp/analysis/derivatives/trains/)
- Calculators: [WolframAlpha](https://www.wolframalpha.com/calculators/derivative-calculator/){:target="_blank"}, [Symbolab](https://es.symbolab.com/solver/derivative-calculator){:target="_blank"}
- [Optimization - The cinema popcorn box](/en/MatExp/analysis/derivatives/popcorn-box/)

### 5. Mathematical models: pandemics and COVID-19
...
- [COVID-19 data portals](/en/MatExp/applied/epidemiology/covid-19-portals/)
